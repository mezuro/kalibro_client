...
require 'kalibro_client/entities/configurations/range'
...
require 'kalibro_client/entities/processor/metric_collector'
require 'kalibro_client/entities/processor/metric_result'
require 'kalibro_client/entities/processor/module'
