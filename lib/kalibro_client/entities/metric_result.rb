  ...
  module Entities
    class MetricResult < Model
      ...
      def configuration=(value)
        @configuration = KalibroClient::Entities::MetricConfigurationSnapshot.to_object value
      end
      ...
      def self.history_of(metric_name, module_result_id)
        ...
        create_array_from_hash(response).map { |date_metric_result| KalibroClient::Entities::DateMetricResult.new date_metric_result }
      end
    end
  end
end
